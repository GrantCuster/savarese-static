...
function widget($args, $instance) {
	...
	while ( $cat_posts->have_posts() )
	{
		$cat_posts->the_post();
	?>
	<?php if ( in_category('upcoming-events') ) { ?>
	<?php $display=get_post_meta($post->ID, 'display', true); ?>
   	<?php if ( $display ) { ?>
		<li class="cat-post-item">
   			<a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark">
			<div class="clearfloat"></div>
			<div class="upcomingdates"><?php get_custom_field_value('month'); ?> <?php get_custom_field_value('day'); ?> <?php get_custom_field_value('year'); ?></div>
			<div class="clearfloat"></div>
			<div class="upcominglocation"><?php get_custom_field_value('subtitle'); ?></div>
			<div class="upcomingtitle"><?php the_title(); ?></div>
			</a>
		</li>
	<?php } ?>
	<?php } else { ?>
