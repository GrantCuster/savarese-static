...
/* Here comes ACE patch ;) */
  ...
  ?>
  		<?php echo $before_widget; ?>
  			...
  			<?php if ( post_is_in_descendant_category( 8 ) ) { ?>
  			<img src="http://grantcuster.com/savarese/wp-content/themes/twentyten/images/reasonable-peoplethumbnail.png"><div class="recentpostcontentthumbnail">
			<?php } elseif ( post_is_in_descendant_category( 5 ) ) { ?>
			<img src="http://grantcuster.com/savarese/wp-content/themes/twentyten/images/seneca-reviewthumbnail.png"><div class="recentpostcontentthumbnail">
			<?php } elseif ( post_is_in_descendant_category( 22 ) ) { ?>
			<img src="http://grantcuster.com/savarese/wp-content/themes/twentyten/images/papaphdthumbnail.png"><div class="recentpostcontentthumbnail">
			<?php } elseif ( post_is_in_descendant_category( 20 ) ) { ?>
			<img src="http://grantcuster.com/savarese/wp-content/themes/twentyten/images/dsqthumbnail.png"><div class="recentpostcontentthumbnail">
  			<?php } else {?>
  			<div class="recentpostcontent">
  			<?php } ?>
  				<div class="recentpostcategory"><?php $category = get_the_category(); echo $category[0]->cat_name; ?>:</div>
  				<div class="recentposttitle"><?php the_title(); ?></div>
  			</div>
  			</a>
    		<div class="clearfloat"></div>
			</li>
